...
set CLASSPATH=%APP_HOME%\lib\Test-1.0.jar;%APP_HOME%\lib\log4j-api-2.8.2.jar;%APP_HOME%\lib\log4j-core-2.8.2.jar

@rem Execute Test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_OPTS%  -classpath "%CLASSPATH%" StartApplication %CMD_LINE_ARGS%
